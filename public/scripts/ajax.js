		...
		<li>
                <p>  
                 ...
                 <p> ${data.text} </p> 
                    ...
                    <form class="delete" action="${actionUrl +"/"+ data._id}?_method=DELETE" method="POST">
                     <button class="btn btn-xs btn-danger ">DELETE </button>
                    </form>
                    
                    <form action="${actionUrl +"/"+ data._id}?_method=PUT" class="edit-comment-form">
                      <div class="row">
			...
			this.originalItem.html(
				`
                 ...
                 <p> ${data.text} heehe </p> 
                    ...
                    <a href="#" class="btn btn-xs btn-warning edit-button"> Edit</a>
                    <form class="delete" action="/posts/${data._id}/comments/${data._id }?_method=DELETE" method="POST">
                     <button class="btn btn-xs btn-danger ">DELETE </button>
                    </form>
